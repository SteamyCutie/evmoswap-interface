  ...
  return (
    ...
    <div className="w-10/12">
      <div className="justify-between md:flex">
        <div className="w-3/5">
          <div className="absolute mt-[32.38rem] ml-[8.06rem]">
            <Image src="/coin1.png" height="59px" width="78px" alt="coin1" />
          </div>
          <div className="absolute mt-[16.69rem] ml-[29.44rem]">
            <Image src="/coin2.png" height="60px" width="73px" alt="coin2" />
          </div>
          <div className="absolute mt-[28.89rem] ml-[31.62rem]">
            <Image src="/coin3.png" height="67px" width="69px" alt="coin3" />
          </div>
        ...
        <div className="w-2/5 mt-[2.94rem]">
          <Image src="/coins.png" height="446px" width="472px" alt="coins" />
        </div>
      </div>
