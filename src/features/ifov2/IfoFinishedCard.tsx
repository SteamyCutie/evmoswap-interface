        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          ...
          <div className="relative flex flex-col px-4 pt-8 space-y-8 rounded-r bg-dark-800">
            ...
            <div className="mx-auto">
              <Image src="/images/ifo/emo.png" alt="CronaSwap" width="285px" height="55px" />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-4 pb-4">
                <a href="https://twitter.com/emoswap" target="_blank" rel="noreferrer">
                ...
                <a href="https://emoswap.medium.com/" target="_blank" rel="noreferrer">
