...
const activeTabStyle = `${tabStyle} flex justify-center items-center w-full h-8 rounded font-bold md:font-medium lg:text-lg text-sm bg-dark-900`
                    ...
                    <div className="flex flex-col w-full lg:w-3/5 space-y-8">
                        ...
                        >
                            ...
                            <ul className="list-disc ml-4 my-4">
                                <li>{ i18n._( t`${token.symbol} yield rewards 1 month vesting period, but can be claimed early at a 50% penalty.` ) }</li>
                        ...
                        <div className="p-4 space-y-4 rounded bg-dark-900 bg-opacity-80">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-2 lg:gap-0 w-full justify-between p-2 py-4">
                                <div className="col-span-2">
                                    <div className="text-lg mb-4">{ i18n._( t`Locker Rewards` ) }</div>
                                    <div>
                                        {
                                ...
                                <div className="flex items-center">
                                    {
                                        rewards && rewards.total.lte( 0 ) ? (
                                            ...
                                            { pendingTx ? <Dots>{ i18n._( t`Claiming` ) } </Dots> : i18n._( t`Claim` ) }
                                        </Button>
                                    }
                                </div>
                            </div>
                            ...
                            {/** Lock tab content */
                                ...
                                <div className="mt-8">
                                    ...
                                    { !lockExpired && <React.Fragment>
                                        ...
                                        { lockAmount.greaterThan( ZERO ) && <div className="grid grid-cols-2 gap-0 p-1 rounded bg-dark-800 mt-4 mb-8">
                                            <button
                                        ...
                                        { ( activeTab === 0 || !lockAmount.greaterThan( ZERO ) ) &&
                                            <div>
                                                ...
                                                <button className="absolute rounded-2xl text-xs px-2 py-1 -ml-16 mt-[1.3rem] md:bg-cyan-blue md:bg-opacity-30 border border-secondary md:border-cyan-blue pointer-events-auto focus:outline-none focus:ring hover:bg-opacity-40 hover:bg-cyan-blue hover:bg-opacity-30 md:text-cyan-blue md:py-1 md:px-3 md:-ml-20 md:text-sm md:font-normal md:text-cyan-blue" 
                                                    onClick={ () => {
                                                ...
                                                <div className="grid grid-cols-2 gap-2 mt-4 md:grid-cols-3">
                                                    ...
                                                    <Input.Numeric
                                                        ...
                                                        className={ classNames(
                                                            ...
                                                            week ? 'bg-blue text-white bg-opacity-50' : 'bg-dark-800 text-dark-800'
                                                        ) }
