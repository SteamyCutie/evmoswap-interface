import { Currency, NATIVE, WNATIVE, currencyEquals } from '@evmoswap/core-sdk'
...
export default function RemoveLiquidityReceiveDetails ( {
    ...
    return (
        <div id={ id } className="p-5 rounded bg-light-secondary dark:bg-dark-secondary">
            <div className="flex flex-col justify-between space-y-3 sm:space-y-0 sm:flex-row">
                ...
                <div className="flex flex-col space-y-3 md:flex-row md:space-x-6 md:space-y-0">
                    <div className="flex flex-row items-center w-full p-3 space-x-4 rounded bg-light dark:bg-dark">
