...
import { ChainId, FACTORY_ADDRESS, JSBI, Pair, Percent, Token, computePairAddress } from '@evmoswap/core-sdk'
import {
  SerializedPair,
  SerializedToken,
  addSerializedPair,
...
export function useGasPrice(): string {
  ...
  return chainId === ChainId.EVMOS.toString() ? userGas : GAS_PRICE_GWEI.testnet
}
