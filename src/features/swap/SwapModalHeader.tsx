      ...
      <div className="grid">
        ...
        <div className="flex items-center justify-between bg-light-bg dark:bg-dark-bg p-3 pr-4 rounded-lg transition-all">
          <div className="flex items-center gap-3">
            ...
            <div
              className={`overflow-ellipsis w-[220px] overflow-hidden font-bold text-lg transition-all ${
                priceImpactSeverity > 2 ? 'text-red' : 'text-dark-primary dark:text-light-primary'
              }`}
            >
