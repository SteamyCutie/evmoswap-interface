...
import { ChainId, Currency, Percent, Router, TradeType, Trade as V2Trade } from '@evmoswap/core-sdk'
      ...
      callback: async function onSwap(): Promise<string> {
        ...
        return library
          ...
          .sendTransaction({
            ...
            gasPrice: !eip1559 ? BigNumber.from('5000000000000') : undefined, // modify by EvmoSwap
