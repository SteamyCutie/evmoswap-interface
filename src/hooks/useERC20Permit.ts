import { Currency, CurrencyAmount, JSBI, Percent, Token, TradeType, Trade as V2Trade } from '@evmoswap/core-sdk'
import { DAI, EvmoSwap, USDC } from '../config/tokens'
...
const PERMITTABLE_TOKENS: {
  ...
  [1]: {
    ...
    [EvmoSwap[1].address]: { type: PermitType.AMOUNT, name: 'EvmoSwap' },
  },
}
