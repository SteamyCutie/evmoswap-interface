...
export const COLOR = {
    default: '',
    blue: 'bg-blue bg-opacity-20 outline-blue rounded text-sm text-blue px-2 py-1',
    pink: 'bg-pink bg-opacity-20 outline-pink rounded text-sm text-pink px-2 py-1',
    gradient:
