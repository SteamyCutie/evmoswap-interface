        ...
        >
            ...
            <div className="justify-center flex-auto ml-4">
                ...
                <div className="relative flex flex-row">
                    <div className={ classNames( isActive && 'text-white', 'text-sm' ) }>{ list.tokens.length } tokens</div>
    ...
    return (
        <div style={ { height: `${height}px` } } className="flex flex-col space-y-4">
            <input
                ...
                className="mt-4 w-full bg-light dark:bg-dark border border-dark-800 focus:border-transparent focus:border-gradient-r-blue-red-dark-900 rounded placeholder-secondary focus:placeholder-primary font-bold text-base px-6 py-3.5 appearance-none"
                value={ listUrlInput }
                    ...
                    <RowBetween>
                        <RowFixed>
                            ...
                            <AutoColumn gap="4px" style={ { marginLeft: '20px' } }>
                                ...
                                <div className="text-sm">{ tempList.tokens.length } tokens</div>
                            </AutoColumn>
                        </RowFixed>
                        { isImported ? (
                            <RowFixed>
