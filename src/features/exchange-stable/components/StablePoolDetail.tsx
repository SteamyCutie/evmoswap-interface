...
const StablePoolDetail = ( { poolInfo, showHeader = false, showPosition = false, className = '' }: { poolInfo: StablePoolInfo, showHeader?: boolean, showPosition?: boolean, className?: string } ) => {
    ...
    return (
        <>
            ...
            { poolInfo && <div className={ classNames( "grid gap-4 rounded bg-dark-800 text-high-emphesis", className ) }>
