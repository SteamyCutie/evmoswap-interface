...
export const EXCHANGE = {
  ...
  [ChainId.EVMOS]: 'evmoswap/exchange',
}

export const exchange = async (chainId = ChainId.EVMOS, query, variables = {}) =>
...
export const getTokens = async (chainId = ChainId.EVMOS, variables) => {
...
export const getNativePrice = async (chainId = ChainId.EVMOS, variables = undefined) => {
