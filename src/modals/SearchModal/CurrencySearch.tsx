import { ChainId, Currency, NATIVE, Token } from '@evmoswap/core-sdk'
    ...
    return (
        <div className="flex flex-col max-h-[inherit]">
            ...
            { searchToken && !searchTokenIsAdded ? (
                ...
                <div className="h-screen p-2 transition-all border-2 border-light-secondary dark:border-dark-secondary rounded-2xl">
