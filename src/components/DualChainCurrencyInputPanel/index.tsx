import { AbstractCurrency, Binance, ChainId, Currency, CurrencyAmount, Ether, Token } from '@evmoswap/core-sdk'
...
import { AnyswapTokensMap } from '../../pages/bridge-old'
                        ...
                        >
                            <div className="flex">
                                ...
                                <div className="flex flex-1 flex-col items-start justify-center mx-3.5">
                                    { label && <div className="text-sm font-medium text-secondary whitespace-nowrap">{ label }</div> }
                                    <div className="flex items-center">
            ...
            >
                <div className="flex flex-row justify-between flex-1">
                    <div className={ classNames( 'w-full sm:w-96 text-right px-3' ) }>
                        <div className="text-sm font-medium text-secondary whitespace-nowrap">Balance on { chainTo?.name }:</div>
                    </div>
