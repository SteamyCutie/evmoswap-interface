    ...
    return (
        <HeadlessUiSwitch
            ...
            className={ classNames(
                `flex items-center bg-light-secondary dark:bg-dark-secondary border border-dark-700 relative inline-flex flex-shrink-0 rounded-full cursor-pointer ease-in-out duration-200 ${id}`
            ) }
            style={ { height, width } }
        >
            <span
