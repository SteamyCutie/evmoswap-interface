                        ...
                        <div className="flex gap-x-2">
                            ...
                            <div className="flex items-center w-1/2 col-span-2 space-x-4 lg:gap-5 lg:w-4/12 lg:col-span-1">
                                ...
                                <div className="flex flex-col justify-center">
                                    <div className="text-sm font-bold md:text-2xl">Manual EMO</div>
                                    <div className="hidden text-sm md:block text-gray">{ i18n._( t`Earn EMO, Stake EMO` ) }</div>
                                </div>
                            </div>

                            {/* Earned */ }
                            <div className="flex flex-col justify-center w-2/12 space-y-1">
                                <div className="text-sm md:text-[14px] text-secondary">{ i18n._( t`EMO Earned` ) }</div>
                            ...
                            <div className="flex flex-col justify-center w-3/12 space-y-1 lg:w-2/12">
                                ...
                                <div className="flex items-center" onClick={ () => setShowCalc( true ) }>
                                    <div className="text-sm font-bold md:text-base">{ formatPercent( manualAPY ) } </div>
