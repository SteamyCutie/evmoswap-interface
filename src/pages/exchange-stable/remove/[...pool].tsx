    ...
    const checkError = () => {
        ...
        if ( !error ) {
            ...
            const checkError = () => {
                ...
                if ( !error ) {
                    ...
                    if ( !balance || !poolBalances ) {
                        ...
                        singleMode &&
                        poolBalances &&
                        Number( amount.toExact() ) > Number( poolBalances[ selectTokenIndex ].toExact() )
                    ) {
            ...
            async function onRemove () {
                ...
                const minAmounts = singleMode
                    ? minToMintsWithSlippage[ selectTokenIndex ].quotient.toString()
                    : minToMintsWithSlippage.map( ( e, i ) => e.quotient.toString() )
                ...
                args = [ tokenInputBN, selectTokenIndex, minAmounts, deadline.toHexString() ]

                //remove token index in not single mode
                if ( !singleMode ) args.splice( 1, 1 )
                ...
                <div className="grid gap-4 pt-3 pb-4">
                    ...
                    { notLastIndex && (
                        <div className="flex justify-center -my-5 z-0">
                            <div className="p-2 border-4 border-light-primary dark:border-dark-primary z-1 rounded-2.5xl text-dark-primary dark:text-light-primary bg-light-secondary dark:bg-dark-secondary transition-all">
                ...
                <div>
                    ...
                    <AutoColumn gap="md">
                        <div>
                            ...
                            <div className="flex justify-center -mt-3.5 -mb-5">
                                <div className="p-2 border-4 border-light-secondary dark:border-dark-secondary z-1 rounded-2.5xl text-dark-primary dark:text-light-primary bg-light-primary dark:bg-dark-primary transition-all">
                                    <ArrowSmDownIcon width={ 24 } height={ 24 } />
                                </div>
                            </div>
                                            ...
                                            <div className="flex flex-col space-y-2 md:flex-row md:space-x-2 md:space-y-0">
                                                { ( !singleMode ? tokens : [ tokens[ selectTokenIndex ] ] ).map( ( token, i ) => {
                                                    ...
                                                    return (
                                                        <div
                                                            className={ classNames(
                                                                'flex flex-row items-center w-full py-3 pl-4 pr-8 space-x-3 rounded-xl text-dark-primary dark:text-light-primary bg-light-secondary dark:bg-dark-secondary transition-all'
                                                            ) }
                                                            key={ index }
                                                        >
                                                            ...
                                                            <div className="flex flex-col -space-y-1">
                                                                ...
                                                                <div className="text-lg font-extrabold">{ token?.symbol }</div>
                                                            </div>
                                                        </div>
                                                    )
                                                } ) }
