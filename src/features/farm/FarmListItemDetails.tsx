            ...
            <div className={ classNames( '' ) }>
                ...
                <div className={ classNames( COLUMN_CONTAINER, content ? 'hidden' : '' ) }>
                    <HeadlessUiModal.Header
                        header={
                            <div className="flex gap-0.5 items-center font-semibold text-xl text-dark dark:text-light">
                        ...
                        onClose={ onDismiss }
                    />
                    <ToggleButtonGroup size="sm" value={ view } onChange={ ( view: OnsenModalView ) => setView( view ) } variant="filled" className={ 'bg-light dark:bg-dark mt-4' }>
                        <ToggleButtonGroup.Button value={ OnsenModalView.Liquidity } className="!font-semibold">{ i18n._( t`Liquidity` ) }</ToggleButtonGroup.Button>
                        <ToggleButtonGroup.Button value={ OnsenModalView.Staking } className="!font-semibold">{ i18n._( t`Staking` ) }</ToggleButtonGroup.Button>
                        <ToggleButtonGroup.Button value={ OnsenModalView.Position } className="!font-semibold">{ i18n._( t`Rewards` ) }</ToggleButtonGroup.Button>
                    </ToggleButtonGroup>
