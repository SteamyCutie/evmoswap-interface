  ...
  if (account) {
    return (
      <div
        ...
        className="flex items-center px-3 py-2 m-0.5 text-sm rounded-xl bg-light-bg dark:bg-dark-bg transition-all text-dark-primary/80 dark:text-light-primary/80"
