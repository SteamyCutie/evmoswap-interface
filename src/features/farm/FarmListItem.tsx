...
const BG = 'bg-light-secondary dark:bg-dark-secondary hover:bg-light-secondary/50 dark:hover:bg-dark-secondary/50 md:!bg-transparent md:dark:!bg-transparent';
const SPACING = 'rounded-2xl my-4 md:my-0';
export const TABLE_TBODY_TR_CLASSNAME = `flex flex-col md:grid md:grid-cols-6 gap-0 md:gap-2 p-4 md:p-0 w-auto md:min-w-[1024px] hover:cursor-pointer ${BG} ${SPACING}`
