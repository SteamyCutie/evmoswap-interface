    ...
    return (
        <div className="form-check my-1">
            <input
                ...
                className={ `form-check-input appearance-none h-[18px] w-[18px] rounded-sm bg-light dark:bg-dark border-[1px] border-gray-600 disabled:bg-dark-1000 disabled:border-dark-800 transition duration-200 align-top bg-no-repeat bg-center bg-contain float-left cursor-pointer ${COLOR[ color ]} ${className}` }
                style={ {
