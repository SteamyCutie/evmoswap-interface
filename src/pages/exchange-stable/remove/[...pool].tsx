              ...
              <React.Fragment key={index}>
                ...
                {notLastIndex && (
                  <div className="flex justify-center -my-5 z-0">
                    <div className="p-2 border-4 border-light-primary dark:border-dark-primary z-1 rounded-2.5xl text-dark-primary dark:text-light-primary bg-light-bg dark:bg-dark-bg transition-all">
            ...
            <AutoColumn gap="md">
              <div>
                ...
                <div className="flex justify-center -mt-3.5 -mb-5">
                  <div className="p-2 border-4 border-light-bg dark:border-dark-bg z-1 rounded-2.5xl text-dark-primary dark:text-light-primary bg-light-primary dark:bg-dark-primary transition-all">
                        ...
                        return (
                          <div
                            className={classNames(
                              'flex flex-row items-center w-full py-3 pl-4 pr-8 space-x-3 rounded-xl text-dark-primary dark:text-light-primary bg-light-bg dark:bg-dark-bg transition-all'
                            )}
                            key={index}
                          >
