...
const Swap = () => {
    ...
    return (
        <Container id="swap-page" className="p-4 md:py-8 lg:pb-24 mt-4 sm:mt-0 max-w-xl">
            <Head>
                ...
                <div className="gap-4 p-3 md:p-4 lg:p-6 transition-all rounded-2.5xl z-0">
                    ...
                    <div>
                      ...
                      /> */}
                                ...
                                { isExpertMode ? (
                                    <div className="flex items-center transition-all text-dark-secondary dark:text-light-secondary hover:text-dark-secondary/80 dark:hover:text-light-secondary/80">
