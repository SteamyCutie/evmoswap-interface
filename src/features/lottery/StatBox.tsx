...
export const StatBox: React.FC<StatBoxProps> = ( { content, stat } ) => {
    return (
        <div className="p-[0.5px] bg-white rounded-md bg-gradient-to-tr from-[#FF0058] via-[#FFEB17] to-[#093BE4]">
            <div className="py-6 pl-6 pr-32 bg-dark-900 border-[1px] rounded-md">
