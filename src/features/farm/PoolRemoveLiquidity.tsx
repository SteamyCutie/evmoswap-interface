    ...
    return (
      <>
        <div className="p-4 rounded-lg bg-dark-1000">
          <div className="grid gap-1 pb-6">
            <div className="">
              ...
              <div className="p-2 text-sm border-[1px] font-bold border-gray-600 rounded-lg bg-dark-800 text-high-emphasis">
        ...
        <div className="p-4 rounded-lg bg-dark-1000">
          ...
          <div className="flex items-center gap-2 p-2 mt-2 border-[1px] border-gray-600 rounded-t-lg bg-dark-800">
            <CurrencyLogo currency={currencyA} />
            {parsedAmounts[Field.CURRENCY_A]?.toSignificant(6)} {currencyA?.symbol}
          </div>
          <div className="flex items-center gap-2 p-2 border-[1px] border-gray-600 rounded-b-lg bg-dark-800">
