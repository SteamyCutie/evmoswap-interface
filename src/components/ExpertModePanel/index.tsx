    ...
    return (
        <div className="">
            <div className="h-[34px] flex justify-end">
                <div className="bg-light-secondary dark:bg-dark-secondary rounded-tr rounded-tl-full gap-6 flex items-center -mb-2 relative justify-between pr-3 pl-8">
            ...
            <div className="border border-[2px] border-gray-800 rounded bg-light dark:bg-dark">{ children }</div>
        </div>
    )
}
