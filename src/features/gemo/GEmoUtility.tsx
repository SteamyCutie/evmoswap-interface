      ...
      <div className="grid gap-4 grid-cols-2 md:grid-cols-4">
        <div className="grid col-span-2 gap-3">
          <div className={styleCard}>
            ...
            <div className="flex items-center justify-center text-xs font-extrabold text-yellow">Hold in Wallet</div>
          </div>
          <div className="grid grid-cols-9 justify-center items-center bg-dark-900 rounded-xl px-4 md:px-8">
            <div className={`${styleIllustr} col-span-4`}>
              ...
              <div className="text-center text-xs min-h-[80px]">Collect a 2% Reflect Fee on all GNANA Transactions</div>
            ...
            <div className={`${styleIllustr} col-span-4`}>
              ...
              <div className="text-center text-xs min-h-[80px]">Propose and Vote on platform decisions</div>
        ...
        <div className="grid gap-3">
          <div className={styleCard}>
            ...
            <div className="flex items-center justify-center text-xs font-extrabold text-yellow">Stake</div>
          </div>
          <div className={styleIllustr}>
            ...
            <div className="text-center text-xs min-h-[80px]">Access unique pools with higher APRs</div>
            <Link href="/pool" passHref>
              <a target="_blank" rel="noreferrer noopenner" className="w-full">
                <Button color="blue" variant="filled" className="uppercase transition-all duration-300">
                  Go to Pools
        ...
        <div className="grid gap-3">
          <div className={styleCard}>
            ...
            <div className="flex items-center justify-center text-xs font-extrabold text-yellow">Commit</div>
          </div>
          <div className={styleIllustr}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="text-center text-xs min-h-[80px]">
