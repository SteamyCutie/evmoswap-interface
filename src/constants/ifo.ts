...
const ifos: Ifo[] = [
  ...
  },
  {
    id: 'duet',
    address: {
      [ChainId.EVMOS]: '0xDF24BE326af4c1fb888f567f41D9a981A4752cf1',
      [ChainId.BSC]: '0xDF24BE326af4c1fb888f567f41D9a981A4752cf1',
      [ChainId.EVMOS_TESTNET]: '0xDF24BE326af4c1fb888f567f41D9a981A4752cf1',
    },
    isActive: false,
    name: 'DUET',
    poolBasic: {
  ...
  },
  {
    id: 'era',
    address: {
      [ChainId.EVMOS]: '0x527201a43f8da24ce9b7c21744a0706942f41fa3',
      [ChainId.BSC]: '0x527201a43f8da24ce9b7c21744a0706942f41fa3',
      [ChainId.EVMOS_TESTNET]: '0x527201a43f8da24ce9b7c21744a0706942f41fa3',
    },
    isActive: false,
    ...
    offerToken: {
      [ChainId.EVMOS]: new Token(ChainId.EVMOS, '0x6f9F0c4ad9Af7EbD61Ac5A1D4e0F2227F7B0E5f9', 18, 'ERA', 'Era Token'),
    },
    releaseTimestamp: 1646922000,
    claimDelayTime: 10800, //delay 3 hours
    veEmoCheckPoint: 1646813700, //start time
  ...
  {
    id: 'froyo',
    address: { [ChainId.EVMOS_TESTNET]: '0xE0d6c91860a332068bdB59275b0AAC8769e26Ac4' },
    isActive: false,
    ...
    offerToken: {
      [ChainId.EVMOS_TESTNET]: tokens.froyo,
    },
  ...
  {
    id: 'dpt',
    address: { [ChainId.EVMOS_TESTNET]: '0x63914805A0864e9557eA3A5cC86cc1BA054ec64b' },
    isActive: false,
    ...
    offerToken: { [ChainId.EVMOS_TESTNET]: tokens.dpt },
    claimDelayTime: 10800, //delay 3 hours
    veEmoCheckPoint: 1646813700, //start time
  ...
  {
    id: 'santos',
    address: { [ChainId.EVMOS_TESTNET]: '0x69B5D2Ab0cf532a0E22Fc0dEB0c5135639892468' },
    isActive: false,
    ...
    offerToken: { [ChainId.EVMOS_TESTNET]: tokens.santos },
    claimDelayTime: 10800, //delay 3 hours
    veEmoCheckPoint: 1646813700, //start time
  ...
  {
    id: 'porto',
    address: { [ChainId.EVMOS_TESTNET]: '0xFDFf29dD0b4DD49Bf5E991A30b8593eaA34B4580' },
    isActive: false,
    ...
    offerToken: { [ChainId.EVMOS_TESTNET]: tokens.porto },
    claimDelayTime: 10800, //delay 3 hours
    veEmoCheckPoint: 1646813700, //start time
  ...
  {
    id: 'dar',
    address: { [ChainId.EVMOS_TESTNET]: '0xb6eF1f36220397c434A6B15dc5EA616CFFDF58CE' },
    isActive: false,
    ...
    offerToken: { [ChainId.EVMOS_TESTNET]: tokens.dar },
    claimDelayTime: 10800, //delay 3 hours
    veEmoCheckPoint: 1646813700, //start time
  ...
  {
    id: 'dkt',
    address: { [ChainId.EVMOS_TESTNET]: '0x89ab9852155A794e371095d863aEAa2DF198067C' },
    isActive: false,
    ...
    offerToken: { [ChainId.EVMOS_TESTNET]: tokens.dkt },
    claimDelayTime: 10800, //delay 3 hours
    veEmoCheckPoint: 1646813700, //start time
  ...
  {
    id: 'kalmar',
    address: { [ChainId.EVMOS_TESTNET]: '0x1aFB32b76696CdF05593Ca3f3957AEFB23a220FB' },
    isActive: false,
    name: 'Kalmar (KALM)',
    poolBasic: {
    ...
    offerToken: { [ChainId.EVMOS_TESTNET]: tokens.kalm },
    claimDelayTime: 10800, //delay 3 hours
    veEmoCheckPoint: 1646813700, //start time
  ...
  {
    id: 'hotcross',
    address: { [ChainId.EVMOS_TESTNET]: '0xb664cdbe385656F8c54031c0CB12Cea55b584b63' },
    isActive: false,
    ...
    offerToken: { [ChainId.EVMOS_TESTNET]: tokens.hotcross },
    claimDelayTime: 10800, //delay 3 hours
    veEmoCheckPoint: 1646813700, //start time
  ...
  {
    id: 'horizon',
    address: { [ChainId.EVMOS_TESTNET]: '0x6137B571f7F1E44839ae10310a08be86D1A4D03B' },
    isActive: false,
    ...
    offerToken: { [ChainId.EVMOS_TESTNET]: tokens.hzn },
    claimDelayTime: 10800, //delay 3 hours
    veEmoCheckPoint: 1646813700, //start time
