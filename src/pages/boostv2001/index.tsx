...
import { NATIVE, ZERO, Token } from '@evmoswap/core-sdk'
...
export default function Boostv2() {
  ...
  const allFarms = Object.keys(FARMS[chainId]).map((key) => {
    return { ...FARMS[chainId][key], lpToken: key, isBoost: false }
  })
  ...
  return (
    <Container id="bar-page" className="py-4 md:py-8 lg:py-12" maxWidth="full">
      <Head>
        <title key="title">Boostv2 | EvmoSwap</title>
      ...
      <div className="flex flex-col items-center justify-start flex-grow w-full h-full">
        <div className="items-center w-full px-4 py-4 max-w-7xl">
          <div className="flex flex-col space-y-4">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4 auto-cols-max">
              <div className="grid items-center grid-cols-1 p-4 rounded-lg bg-dark-800">
                ...
                >
                  ...
                  {/* <CalculatorIcon className="hidden w-5 h-5" /> */}
                </div>
                <ROICalculatorModal
                  isfarm={false}
                  isOpen={showCalc}
            ...
            <div className="gap-4 md:flex">
              ...
              <div className="mt-4 rounded-lg md:mt-0 md:w-1/2 bg-dark-900">
                <div className="flex items-center justify-between px-8 py-6 rounded-t-lg md:py-8 bg-dark-800">
                  <h1 className="text-xl font-bold md:text-2xl">Global votes</h1>
                  <ChartIconButton handler={() => setShowChart(true)} />
                  <VoteChartModal isOpen={showChart} onDismiss={() => setShowChart(false)} data={chData} />
                </div>
                <div className="p-4">
                  <div className="flex p-2 text-sm border-b-2 md:text-lg border-dark-700">
            ...
            <div className="w-full text-white bg-gray-900 rounded-lg">
              <div className="flex items-center px-8 py-6 rounded-t-lg md:py-8 bg-dark-800">
                <h1 className="text-lg font-bold md:text-2xl">{i18n._(t`Vote to boost your farm`)}</h1>
              ...
              <div className="px-8 py-6 space-y-2 md:py-8 md:space-y-0 md:grid md:grid-cols-1 lg:flex bg-dark-900">
                <div className="w-full lg:w-3/5 md:flex">
                  <div className="w-full md:w-1/3 lg:w-1/3">
                    <div className="mb-4 font-Poppins">{i18n._(t`Select boosted farms`)}</div>
                    <div className="py-3 pl-4 pr-2 border-2 h-80 rounded-xl border-dark-650">
                      <div className="flex w-full overflow-y-auto" style={{ height: '-webkit-fill-available' }}>
                        <div className="grid items-center w-full gap-2" style={{ height: 'fit-content' }}>
                  ...
                  <div className="w-full mt-4 md:w-2/3 lg:w-2/3 md:mt-0 md:px-4 ">
                    <div className="flex-row items-center justify-between mb-4 md:flex">
                    ...
                    <div className="flex p-2 pr-1 border-2 h-60 rounded-xl border-dark-650">
                      <div className="flex w-full overflow-y-auto">
                        <div
                          className="grid items-center w-full grid-cols-1 gap-2 px-2 py-2 md:grid-cols-2"
