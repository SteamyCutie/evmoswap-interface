    ...
    return (
        <div
            className={ classNames(
                'grid gap-1 text-sm bg-light-primary dark:bg-dark-primary text-dark-primary dark:text-light-primary transition-all font-medium',
                className
            ) }
        >
            <div className="flex justify-between items-center">
                <div className="text-sm">{ i18n._( t`Share of Pool` ) }</div>
                <div className="font-semibold">{ shareOfPool }</div>
            </div>
            <div className="flex justify-between items-center">
                ...
                <div className="font-semibold">{ formatNumberPercentage( percent, 100 ) }</div>
            </div>
            <div className="flex justify-between items-center">
                <div className="flex items-center">
                ...
                <div className="font-semibold">{ estimatedSLP?.toSignificant() }</div>
            </div>
        </div>
    )
}
